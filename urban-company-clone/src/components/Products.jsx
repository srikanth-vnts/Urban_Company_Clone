...
function Products() {
 ...
 //   const [filtered,setFiltered] = useState([]);
    ...
    function getProducts() {
        axios.get('http://localhost:3333/serviceCard/')
            .then(res => {
                setCard(res.data);
                    ...
                    <NameRef>
                        {categories.map((el) => {
                            return <CategoryRef>
                                ...
                                {(el === "Fan") ? <p onClick={executeScroll} style={{
                                    fontSize: "9px",
                                    marginTop: "0px",
                                    marginBottom: "0px",
                                    width: "100%",
            ...
            return (
               <>
                    ...
                    {el === "Fan"?<h4 ref={myRef}>{el}</h4>:<h4>{el}</h4>}
                         <img style={{width:"311px",marginLeft:"13px"}} src={frame37} alt="logo.png" />
                         {filtering(el).map(e => {
                             return (
                                 <CardMain>
                                     <CardMain_1>
                                         <img style={{width:"40px",height:"40px"}} src={e.image} alt="logo.png" />
                                         <CardMain_1_1>
                                                 ...
                                                 <button style={{
                                                     ...
                                                     width:"100%"
                                                         ...
                                                         color: "#304FFE",
                                                             ...
                                                             marginTop: "1px",
                                                             marginLeft:"-1px",
                                                             fontSize: "14px" }}>+</p></div></div></button> : <>
                                                     <button style={{
                                                         height: "20px",
                                                         fontSize: "12px",
                                                         marginRight: "5px",
